...
const User = {
  ...
  getUserByUsernameWithPassword: (username, done) => {
    const queryString =
      "SELECT u.user_id, u.username,u.password, u.access_id, a.type FROM users AS u INNER JOIN access_levels AS a ON u.access_id=a.access_id WHERE username=? LIMIT 1;";
